 ...
 */
router.post("/posts", auth_1.default, postController_1.createPost);
/**
 * @swagger
 * /posts:
 *   get:
 ...
 */
router.put("/posts/:id", auth_1.default, postController_1.updatePost);
/**
 * @swagger
 * /posts/{id}:
 *   delete:
 ...
 *         description: Access denied
 */
router.delete("/posts/:id", auth_1.default, postController_1.deletePost);
